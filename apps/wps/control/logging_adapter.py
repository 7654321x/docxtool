...
SAFE_WPS_LOG_FIELDS = frozenset(
    {
        "active_document_present", "active_element_id", "active_element_tag", "active_window_present", "at_end",
        "actual_delay_ms", "application_available",
        "applied_count", "applied_total", "backup_state",
        "batch_index", "binding_status", "block_count", "block_index", "blocks", "book_count",
        ...
        "chapter_end_offset", "chapter_index", "confirmed", "confirmed_count", "content_bottom", "content_client_height",
        "content_client_width", "content_end_offset", "content_height", "content_scroll_height", "content_top",
        ...
        "direction", "docxtool_version", "duration_ms", "end_offset", "end_utf16", "error_code", "error_type",
        ...
        "start_offset", "start_utf16", "state", "state_revision", "status", "style_profile", "table_paragraph_count", "target_in_current_window", "target_offset", "temporary_state", "text_chars",
