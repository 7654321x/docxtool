...
class DocumentTransactionManager:
    """Own prepared/commit/finalize/rollback state for WPS formatting."""
    ...
    def commit(self, operation_id: str) -> FormatOperation:
        ...
        log_event(
            ...
            "commit.start",
            "宿主已关闭原文档，开始原子替换",
            {"operation_id": operation_id[:8], "file_id": file_identity(operation.source_path)},
        )
