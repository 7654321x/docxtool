...
<body>
<div class="shell">
<aside class="sidebar"><a class="brand" href="/admin"><span class="brand-mark">文</span><span><strong>公文智能排版</strong><small>管理员工作台</small></span></a>
<div class="nav-label">WORKSPACE</div><nav class="side-nav">
<a href="/admin"><span class="nav-index">01</span>综合概览</a><a class="active" href="/admin/web"><span class="nav-index">02</span>网页业务</a><a href="/admin/wps/users"><span class="nav-index">03</span>WPS 插件</a><a href="#security"><span class="nav-index">04</span>安全与访问</a><a href="#runtime"><span class="nav-index">05</span>运行设置</a><a href="#logs"><span class="nav-index">06</span>日志查询</a>
