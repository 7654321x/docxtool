...
def diagnostics_to_json(value: dict[str, Any], *, indent: int | None = 2) -> str:
    ...
    allowed = {"engine_version", "schema_version", "config", "mode", "mode_confidence", "mode_evidence", "beam_width", "blocks", "candidate_trace", "paragraphs", "candidate_quality", "summary", "validation", "structure_tree", "structure_error"}
