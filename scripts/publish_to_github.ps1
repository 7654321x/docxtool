...
$requiredFiles = @(
    ...
    "src/docxtool/web/admin_shell.py",
    "src/docxtool/web/admin_web_pages.py",
    "src/docxtool/web/admin_workspace_page.py",
    "src/docxtool/web/admin_workspace_routes.py",
    "src/docxtool/web/admin_wps_pages.py",
    ...
    "src/docxtool/document/recognition/providers/body_structure.py",
    "src/docxtool/document/recognition/providers/compatibility.py",
    "src/docxtool/document/recognition/providers/inline_heading.py",
