...
TYPE_ID_MAP = {
    ...
    ParagraphType.MEETING_TITLE_META: "meeting_title_meta",
...
RULE_INDEX_MAP = {
    ...
    ParagraphType.MEETING_META: 5, ParagraphType.MEETING_TITLE_META: 12,
    ParagraphType.SIGNATURE_ORG: 22,
    ...
    ParagraphType.ATTACHMENT_BODY: 21,
...
STYLE_ID_MAP.update({
    ...
    ParagraphType.HEADING_4: "DCT-Heading4",
    ...
    ParagraphType.MEETING_TITLE_META: "DCT-Author",
